...
`SEDust/data/<model>/sedust_<model>.h5` (~41 MB for the four), and those are
...
| `plot_model_compare.py` | Overlay the astrodust / DL07 / MRN / Zubko dust-emission SEDs of the `examples/dustemis/model_compare_*` runs. |
