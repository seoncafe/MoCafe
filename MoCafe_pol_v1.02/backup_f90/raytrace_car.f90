...
contains
  ...
  subroutine raytrace_to_dist_car(photon0,grid,dist_in,tau)
!--- Find the optical depth corresponding to an input distance dist_in.
!--- The algorithm is based on the fast Voxel traversal algorithm (Amanatides & Woo 1987; Proc. of Eurographics, 87, 3)
!--- Author: Kwang-Il Seon, 2020-11-30
...
!--- xp, yp, zp = the current photon coordinates.
  ...
  enddo
  end subroutine raytrace_to_dist_car
