...
if keyword_set(all) then begin
   a0 = mrdfits(fname+'_obs.fits.gz',0,/sil)
   a1 = mrdfits(fname+'_obs.fits.gz',1,/sil)
   a  = a0 + a1
endif else begin
   a  = mrdfits(fname+'_obs.fits.gz',0,/sil)
endelse
...
pos  = strpos(fname,'taug')
str  = strmid(fname,pos+strlen('taug'),4)
...
imdisp,a,  /er,/ax, tit=tit_I, margin=margin
