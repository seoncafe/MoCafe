...
!+++++++++++++++++++++++++++++++++++++++++++
  ...
  use compose_mod, only : compose_ext
...
! read parameters
  ...
  !--- version's scope, then initialize the generator.  Runs after the source
  !--- geometry, compose split, and use_stokes are all finalized.
