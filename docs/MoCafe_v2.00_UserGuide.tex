...
\file{SEDust/data/<model>/sedust\_<model>.h5} ($\sim$35\,MB for the three), and
...
\code{dl07} from Mie theory on the astrosilicate and graphite dielectric
functions, \code{zubko} from the $Q_{\rm sca}$ and $\langle\cos\rangle$ columns of
its own tables --- so all three give a physical albedo.  Setting \pp{kext\_file}
...
dust\_model   & 'astrodust' & \textsc{SEDust} grain model: 'astrodust', 'dl07', or 'zubko'\\
...
views are 1129 of 1762 wavelengths for astrodust, 1129 of 1823 for dl07 and 866
of 1201 for zubko, the cut being an index cut at the last node at or below the
