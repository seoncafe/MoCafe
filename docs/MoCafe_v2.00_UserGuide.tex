...
The Lucy emission engine (Mode~1) links the bundled \textsc{SEDust} library,
...
named \code{mathlib} is bundled as \code{sed\_mathlib} to avoid a clash with
...
sed\_qtable, sed\_sizedist & (bundled) & \textsc{SEDust} optics / size-distribution paths\\
...
\item \textbf{Dust-emission engine.}  Run through the bundled \textsc{SEDust}
