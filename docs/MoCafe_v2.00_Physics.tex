...
from Mie theory on the D03 astrosilicate and graphite dielectric functions, its
PAH component entering through absorption alone because a PAH scatters
negligibly; \texttt{zubko} and a file-defined model from the $Q_{\rm sca}$ and
...
\pp{dust\_model}   & grain model (\code{astrodust}/\code{dl07}/\code{zubko}) & \code{astrodust}\\
