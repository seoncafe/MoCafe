...
dielectric functions, MRN having no PAHs at all; \texttt{zubko} and a
file-defined model from the $Q_{\rm sca}$ and $\langle\cos\rangle$ columns of
their own tables.  A PAH population scatters as the graphite fraction
$\xi_{\rm gra}(a)$ of the grain (Hensley \& Draine 2023, eq.~15), a PAH having
an absorption cross section and no scattering one; that term carries a few
percent of $C_{\rm sca}$ at $0.1\,\mu$m and nothing longward of
$0.3\,\mu$m.
...
\item Hensley, B.~S. \& Draine, B.~T. 2023, ApJ, 948, 55 --- the astrodust+PAH
      model; the graphite fraction $\xi_{\rm gra}(a)$.
